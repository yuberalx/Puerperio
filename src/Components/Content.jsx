...
function Content(props) {
    return (
        <><div class="Main">
            <section>
                <div class="Video">
                    <iframe src="https://player.vimeo.com/video/730091509?h=b1fec622c4&autoplay=0&color=A31E22&title=0&byline=0&portrait=0" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
                </div>
                <div class="Autor">
                    <p>
                        Carelyn Mejías
        ...
        <div>
            <div class="Preguntas">
                <section>
                    ...
                    <div>
                        <span class="Nombre">CARELYN MEJÍAS</span>
